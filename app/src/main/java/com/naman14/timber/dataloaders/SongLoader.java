...
public class SongLoader {
    ...
    private static Cursor makeSongCursor(Context context, String selection, String[] paramArrayOfString, String sortOrder) {
      ...
      /*  if (!TextUtils.isEmpty(selection)) {
        ...
        selectionStatement+=onlyMediaMusicFolderSelection;

        Uri uri=MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
        Cursor cur=context.getContentResolver().query(uri, new String[]{"_id", "title", "artist", "album", "duration", "track", "artist_id", "album_id"}, selectionStatement, paramArrayOfString, sortOrder);
        return cur;
    }
