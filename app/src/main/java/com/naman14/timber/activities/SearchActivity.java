...
public class SearchActivity extends BaseActivity implements SearchView.OnQueryTextListener, View.OnTouchListener {
    ...
    public boolean onQueryTextChange(final String newText) {
        return searchQuery(newText, false);
    }

    public boolean searchQuery(final String newText, final Boolean searchYouTube) {
       /* if(newText.equals(queryString)) {
        ...
        if(queryString.trim().equals("")) {
            ...
            mSearchTask=new SearchTask().executeOnExecutor(mSearchExecutor, queryString, searchYouTube.toString());
    ...
    private class SearchTask extends AsyncTask<String, Void, ArrayList<Object>> {
        ...
        protected ArrayList<Object> doInBackground(String... params) {
            ...
            //Execute youtube Search if submitted search
            if(Boolean.parseBoolean(params[1])){
                results.add("YouTube Songs");
                results.addAll(YoutubeSearch.searchYoutubeSongs(queryString));
            }
